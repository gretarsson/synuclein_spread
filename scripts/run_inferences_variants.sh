...
# --------------------------------
# Global
BASE_JOBS["DIFFG_global"]="DIFFG_global data/W_labeled_filtered.csv data/total_path.csv --retrograde=true --n_chains=1"
BASE_JOBS["DIFFGA_global"]="DIFFGA_global data/W_labeled_filtered.csv data/total_path.csv --retrograde=true --n_chains=1"

# regional alpha's
BASE_JOBS["DIFFG_alpha"]="DIFFG_alpha data/W_labeled_filtered.csv data/total_path.csv --retrograde=true --n_chains=1"
BASE_JOBS["DIFFGA_alpha"]="DIFFGA_alpha data/W_labeled_filtered.csv data/total_path.csv --retrograde=true --n_chains=1"
