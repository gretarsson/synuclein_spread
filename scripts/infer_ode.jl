...
factors = [1/100, 1., [1. for _ in 1:N]..., [1 for _ in 1:N]..., [1 for _ in 1:N]..., [1 for _ in 1:N]...]
#factors = [1/100, 1., 1.]
...
# SAVE
serialize("simulations/total_$(ode)_N=$(N)_skipfirst_withu.jls", inference)
