...
declare -A JOBS
JOBS["DIFGAM_BILATERAL"]="DIFFGAM data/W_labeled_filtered.csv data/total_path.csv --retrograde=true --n_chains=4 --out_file=simulations/DIFFGAM_RETRO_BILATERAL.jls"
