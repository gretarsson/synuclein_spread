...
## DIFFG
#BASE_JOBS["DIFFG_RETRO_TGT"]="DIFFG data/W_labeled_filtered.csv data/total_path.csv --retrograde=true --n_chains=1 --target_acceptance=0.9"
#BASE_JOBS["DIFFG_ANTERO_TGT"]="DIFFG data/W_labeled_filtered.csv data/total_path.csv --retrograde=false --n_chains=1  --target_acceptance=0.9"
#BASE_JOBS["DIFFG_BIDIR_TGT"]="DIFFG_bidirectional data/W_labeled_filtered.csv data/total_path.csv --n_chains=1  --target_acceptance=0.9"
#BASE_JOBS["DIFFG_EUCL_TGT"]="DIFFG data/Euclidean_distance_matrix_filtered.csv data/total_path.csv --n_chains=1  --target_acceptance=0.9"
#
## DIFFGA
#BASE_JOBS["DIFFGA_RETRO_TGT"]="DIFFGA data/W_labeled_filtered.csv data/total_path.csv --retrograde=true --n_chains=1  --target_acceptance=0.9"
#BASE_JOBS["DIFFGA_ANTERO_TGT"]="DIFFGA data/W_labeled_filtered.csv data/total_path.csv --retrograde=false --n_chains=1  --target_acceptance=0.9"
#BASE_JOBS["DIFFGA_BIDIR_TGT"]="DIFFGA_bidirectional data/W_labeled_filtered.csv data/total_path.csv --n_chains=1  --target_acceptance=0.9"
...
# DIFF
BASE_JOBS["u0l_DIFF_RETRO"]="DIFF data/W_labeled_filtered.csv data/total_path.csv --retrograde=true --n_chains=1 --ignore_seed"
BASE_JOBS["u0l_DIFF_ANTERO"]="DIFF data/W_labeled_filtered.csv data/total_path.csv --retrograde=false --n_chains=1 --ignore_seed "
BASE_JOBS["u0l_DIFF_BIDIR"]="DIFF_bidirectional data/W_labeled_filtered.csv data/total_path.csv --n_chains=1  --ignore_seed"
BASE_JOBS["u0l_DIFF_EUCL"]="DIFF data/Euclidean_distance_matrix_filtered.csv data/total_path.csv --n_chains=1 --ignore_seed"
             
# DIFFG      
BASE_JOBS["u0l_DIFFG_RETRO"]="DIFFG data/W_labeled_filtered.csv data/total_path.csv --retrograde=true --n_chains=1 --ignore_seed"
BASE_JOBS["u0l_DIFFG_ANTERO"]="DIFFG data/W_labeled_filtered.csv data/total_path.csv --retrograde=false --n_chains=1 --ignore_seed"
BASE_JOBS["u0l_DIFFG_BIDIR"]="DIFFG_bidirectional data/W_labeled_filtered.csv data/total_path.csv --n_chains=1 --ignore_seed"
BASE_JOBS["u0l_DIFFG_EUCL"]="DIFFG data/Euclidean_distance_matrix_filtered.csv data/total_path.csv --n_chains=1 --ignore_seed"
             
# DIFFGA     
BASE_JOBS["u0l_DIFFGA_RETRO"]="DIFFGA data/W_labeled_filtered.csv data/total_path.csv --retrograde=true --n_chains=1 --ignore_seed"
BASE_JOBS["u0l_DIFFGA_ANTERO"]="DIFFGA data/W_labeled_filtered.csv data/total_path.csv --retrograde=false --n_chains=1 --ignore_seed"
BASE_JOBS["u0l_DIFFGA_BIDIR"]="DIFFGA_bidirectional data/W_labeled_filtered.csv data/total_path.csv --n_chains=1 --ignore_seed"
BASE_JOBS["u0l_DIFFGA_EUCL"]="DIFFGA data/Euclidean_distance_matrix_filtered.csv data/total_path.csv --n_chains=1 --ignore_seed"
#
## DIFFGAM
