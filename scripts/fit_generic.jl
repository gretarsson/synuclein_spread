...
priors2 = OrderedDict( "σ" => LogNormal(0,1), "ρₐ" => truncated(Normal(0,0.1), lower=0.), "ρᵣ" => truncated(Normal(0,0.1), lower=0.), "seed" => truncated(Normal(1.,0.1),lower=0) );
...
serialize("simulations/total_diffusion_N=40.jls", inference)
